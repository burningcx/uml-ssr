...
wget http://www.pythoner.win/uml-ssr-64.tar.gz
...
start(){
    ...
    iptables -t nat -A PREROUTING -i venet0 -p tcp --dport 10000:19999 -j DNAT --to-destination 10.0.0.2
	iptables -t nat -A PREROUTING -i venet0 -p udp --dport 10000:19999 -j DNAT --to-destination 10.0.0.2
